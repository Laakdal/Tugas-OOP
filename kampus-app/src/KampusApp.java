...
public class KampusApp {
    ...
    public void showMenu() {
        ...
        System.out.println("\nPilihan Menu Prodi:");
        System.out.println("5 -> Tambah ID Prodi");
        System.out.println("6 -> Ubah ID Prodi");
        System.out.println("7 -> Hapus ID Prodi");
        System.out.println("8 -> Cari ID Prodi");
        System.out.println("\n0 -> Keluar Aplikasi");
    ...
    public void menuTambah() {
        ...
        if (prodi == null) {
            ...
            Mahasiswa mahasiswa = new Mahasiswa(nim, nama, prodi.getId()); 
    ...
    public void menuCari() {
        ...
        if (mahasiswa == null) {
            ...
            Prodi prodi = db.prodiTbl.getProdiById(mahasiswa.getProdi());
            if (prodi != null) {
